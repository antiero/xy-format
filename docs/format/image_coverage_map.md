...
| `+0x07` | **x** | Bar-menu quantization raw byte; UI display is `floor(raw * 100 / 255)` | BAR `bar-q-*` |
...
| `+0x38FF`–`+0x393B` | **~** | Modulation routing matrix | `mod_routing.md` |
| `+0x3917` / `+0x392F` | **x** | Velocity sensitivity / track HPF | corpus |
...
| `+0x453F` | **x** | Preset path string (48 B) | P1-B |
