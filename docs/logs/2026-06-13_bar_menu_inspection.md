...
| Quantization | `+0x07` | raw byte; UI display is `floor(raw * 100 / 255)`. Device-authored anchors include UI 0/1/2/25/50/75/98/99/100 as `00/04/07/41/81/C0/FC/FE/FF`. | `bar-q-*` |
